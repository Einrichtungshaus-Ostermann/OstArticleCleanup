 ...
 *
 * Disables every article which is not within any of the given .csv files
 * which fill the shop with articles via the shopware im/export plugin.
 *
 * 1.0.0
 * - initial release
 *
...
namespace OstArticleCleanup;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstArticleCleanup extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_article_cleanup.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_article_cleanup.view_dir', $this->getPath() . '/Resources/views/');
